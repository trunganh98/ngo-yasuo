...
@section('user_content')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="frontend/img/gallery/case1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="frontend/img/gallery/case2.png" alt="">
                        </div>
                        <div class="cases-caption">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                            <img src="frontend/img/gallery/case3.png" alt="">
                        </div>
                        <div class="cases-caption">
    ...
    <!-- Our Cases End -->
    <!-- Featured_job_start -->
    <section class="featured-job-area section-padding30 section-bg2" data-background="frontend/img/gallery/section_bg03.png">
        <div class="container">
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="frontend/img/gallery/socialEvents1.png" alt=""></a>
                            </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="frontend/img/gallery/socialEvents2.png" alt=""></a>
                            </div>
                            <div class="job-tittle">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="frontend/img/gallery/socialEvents3.png" alt=""></a>
                            </div>
                            <div class="job-tittle">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="frontend/img/gallery/team1.png" alt="">
                            <!-- Blog Social -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="frontend/img/gallery/team2.png" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="frontend/img/gallery/team3.png" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="frontend/img/gallery/team4.png" alt="">
                            <!-- Blog Social -->
                            <ul class="team-social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
    ...
    <section class="wantToWork-area ">
        <div class="container">
            <div class="wants-wrapper w-padding2  section-bg" data-background="frontend/img/gallery/section_bg01.png">
                            ...
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder">
                                    <div class="founder-img mb-40">
                                        <img src="frontend/img/gallery/testimonial.png" alt="">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="frontend/img/gallery/home-blog1.png" alt="">
                                <!-- Blog date -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="frontend/img/gallery/home-blog2.png" alt="">
                                <!-- Blog date -->
                                <div class="blog-date text-center">
                                    <span>24</span>
                                    <p>Now</p>
